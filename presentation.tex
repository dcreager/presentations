...
\begin{frame}[fragile]
    ...
    \uncover<2>{\curvecodeline%
      {[yshift=8pt] pic cs:ref}%
      {+(25:2cm) and +(-45:1cm)}%
      {[yshift=-4pt] pic cs:def}%
    }%
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{minipage}{9em}
    \begin{minted}[autogobble,frame=single,framesep=6pt,label=stove.py,escapeinside=??]{python}
        def broil?\tikzmark{def1}?():
            pass

        def broil?\tikzmark{def2}?():
            pass
    ...
    \uncover<2>{\curvecodeline%
      ...
      {[yshift=8pt] pic cs:ref}%
      {+(15:3cm) and +(-35:1cm)}%
      {[yshift=-4pt] pic cs:def1}%
    }%
    \uncover<2>{\curvecodeline%
      {[yshift=8pt] pic cs:ref}%
      {+(25:2cm) and +(-45:1cm)}%
      {[yshift=-4pt] pic cs:def2}%
    }%
\end{frame}
    ...
    \uncover<2>{%
        \tikz[remember picture]
          \node [overlay, text=red]
            at ([xshift=-2ex, yshift=0.5ex] pic cs:def2)
            {\textbf{\Huge X}};%
    }%
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{minted}[autogobble,frame=single,framesep=6pt,label=kitchen.py,escapeinside=??]{python}
        from stove import ?\tikzmark{import}?broil
    ...
    \uncover<2>{\curvecodeline%
      [-]%
      {[yshift=10pt] pic cs:ref}%
      {+(45:1cm) and +(-155:1cm)}%
      {[yshift=-4pt] pic cs:import}%
    }
    \uncover<2>{\curvecodeline%
      {[xshift=12pt, yshift=10pt] pic cs:import}%
      {+(90:2cm) and +(75:2cm)}%
      {[xshift=-6pt, yshift=10pt] pic cs:def}%
    }
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{minipage}[t]{11em}
    \begin{minted}[autogobble,frame=single,framesep=6pt,label=kitchen.py,escapeinside=??]{python}
        from stove import ?\tikzmark{import}?*
    ...
    \uncover<2>{\curvecodeline%
      ...
      {[yshift=10pt] pic cs:ref}%
      {+(45:1cm) and +(-105:1cm)}%
      {[xshift=1pt, yshift=-2pt] pic cs:import}%
    }
    \uncover<2>{\curvecodeline%
      {[xshift=3pt, yshift=10pt] pic cs:import}%
      {+(90:2cm) and +(75:2cm)}%
      {[xshift=-6pt, yshift=10pt] pic cs:def}%
    }
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{minted}[autogobble,frame=single,framesep=6pt,label=chef.py,escapeinside=??]{python}
        from kitchen import ?\tikzmark{chef_import}?broil
    ...
    \uncover<2>{\curvecodeline%
      ...
      {[yshift=10pt] pic cs:ref}%
      {+(45:1cm) and +(-155:1cm)}%
      {[yshift=-4pt] pic cs:chef_import}%
    }
    \uncover<2>{\curvecodeline%
      [-]%
      {[xshift=10pt, yshift=10pt] pic cs:chef_import}%
      {+(90:5cm) and +(75:2cm)}%
      {[xshift=4pt, yshift=10pt] pic cs:kitchen_import}%
    }
    \uncover<2>{\curvecodeline%
      {[xshift=1pt, yshift=-4pt] pic cs:kitchen_import}%
      {+(-105:1cm) and +(75:1cm)}%
      {[xshift=-6pt, yshift=10pt] pic cs:def}%
    }
\end{frame}
...
\begin{frame}[fragile]
    ...
    \end{center}
    \begin{minted}[autogobble,frame=single,framesep=6pt,label=chef.py,escapeinside=??]{python}
        from kitchen import ?\tikzmark{import}?broil
    ...
    \uncover<2>{\curvecodeline%
      {[xshift=10pt, yshift=10pt] pic cs:import}%
      {+(90:5cm) and +(75:2cm)}%
      {[xshift=-6pt, yshift=10pt] pic cs:def}%
    }
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{minted}[autogobble,frame=single,framesep=6pt,label=chef.py,escapeinside=??]{python}
        ...
        stove?\tikzmark{instance_ref}?.broil?\tikzmark{broil_ref}?()
    \end{minted}
    \end{minipage}
    \end{center}
    \uncover<2- >{\curvecodeline%
      [-, alt=<3>{line width=2pt, blue}{}]%
      {[xshift=-10pt, yshift=-3pt] pic cs:broil_ref}%
    ...
    \uncover<2- >{\curvecodeline%
      ...
      {+(75:1cm) and +(115:1cm)}%
      {[xshift=-10pt, yshift=6pt] pic cs:broil_def}%
    }
\end{frame}
