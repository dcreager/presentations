...
\begin{frame}[fragile]
    ...
    \begin{minted}[autogobble,frame=single,framesep=6pt,label=kitchen.py,escapeinside=??]{python}
        ...
        ?\tikzmark{separate_files_broil_ref_left}?broil?\tikzmark{separate_files_broil_ref_right}?()
    \end{minted}
    \end{minipage}
    \end{center}
    \uncover<2>{\curvecodeline%
      {[xshift=-2pt, yshift=3pt] pic cs:separate_files_broil_ref_left}%
      {+(180:1cm) and +(-45:1cm)}%
      {[yshift=-4pt] pic cs:separate_files_broil_def}%
    }
    \uncover<2>{\curvecodeline%
      [densely dashed]%
      {[yshift=8pt] pic cs:separate_files_broil_ref_right}%
      {+(45:1cm) and +(-155:1cm)}%
...
\begin{frame}[fragile]
    ...
    \begin{minted}[autogobble,frame=single,framesep=6pt,label=kitchen.py,escapeinside=??]{python}
        ...
        ?\tikzmark{separate_files_star_broil_ref_left}?broil?\tikzmark{separate_files_star_broil_ref_right}?()
    \end{minted}
    \end{minipage}
    \end{center}
    \uncover<2>{\curvecodeline%
      {[xshift=-2pt, yshift=3pt] pic cs:separate_files_star_broil_ref_left}%
      {+(180:1cm) and +(-45:1cm)}%
      {[yshift=-4pt] pic cs:separate_files_star_broil_def}%
    }
    \uncover<2>{\curvecodeline%
      [dotted]%
      {[yshift=8pt] pic cs:separate_files_star_broil_ref_right}%
      {+(45:1cm) and +(-105:1cm)}%
      {[yshift=-2pt] pic cs:separate_files_star_import}%
    }
\end{frame}
