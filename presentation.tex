...
\begin{frame}[fragile]
    ...
    \begin{overprint}
        \onslide<4-6,8,13-16> \currentsymbolstack{broil}
        \onslide<3,7,17>      \currentsymbolstack{}
        \onslide<9,12>        \currentsymbolstack{.broil}
        \onslide<10-11>       \currentsymbolstack{stove.broil}
    \end{overprint}
    \end{minipage}
    \end{center}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \vskip 0.75em
    \uncover<4>{The reference at \textsl{kitchen.py:3:1}  might refer to \texttt{stove.broil} in some other file}
