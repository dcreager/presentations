...
\begin{frame}[fragile]
    ...
    \begin{column}{0.7\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \node (s2)         [anon scope]  [above=1cm of s1]     {};
            \node (broil ref)  [reference]   [right=of s2]         {broil};
            \node (s3)         [anon scope]  [above=1cm of s2]     {};
            \node (fry)        [definition]  [right=of s3]         {fry};
            \node (s4)         [anon scope]  [above=1cm of s3]     {};
            \node (broil def)  [definition]  [right=of s4]         {broil};
            \node (s5)         [anon scope]  [above=1cm of s4]     {};
