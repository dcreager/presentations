    ...
    \begin{textblock*}{120mm}(20mm,25mm)
        \begin{center}
            ...
            \only<2>{
                ...
                \vskip 0.5em
                \includegraphics[width=60mm]{images/eelco-curry-on.png}
            }
        \end{center}
    \end{textblock*}
\end{frame}
...
\begin{frame}
    ...
    \begin{textblock*}{10mm}(68mm,29.5mm)
        \only<2>{\includegraphics[width=5mm]{images/python-logo.png}}
    \end{textblock*}
    ...
    \begin{textblock*}{10mm}(68mm,36.25mm)
        \only<2>{\includegraphics[width=5mm]{images/javascript-logo.png}}
    \end{textblock*}
    ...
    \begin{textblock*}{10mm}(68mm,43.5mm)
        \only<2>{\includegraphics[width=5mm]{images/rust-logo.png}}
    \end{textblock*}
    ...
    \begin{textblock*}{10mm}(68mm,50.5mm)
        \only<2>{\includegraphics[width=5mm]{images/ruby-logo.png}}
    \end{textblock*}
    ...
    \begin{textblock*}{10mm}(68mm,57mm)
        \only<2>{\includegraphics[width=5mm]{images/elixir-logo.png}}
    \end{textblock*}
    ...
    \begin{textblock*}{10mm}(68mm,64.75mm)
        \only<2>{\includegraphics[width=5mm]{images/r-logo.png}}
    \end{textblock*}
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[baseline={(current bounding box.center)}]
        ...
        \setwidestsymbol{broil}
        \node (broil2 def) [definition]  [left=of s]                {\sized{broil}};
        \node (saute def)  [definition]  [below=of broil2 def]      {\sized{saute}};
        \node (broil1 def) [definition]  [above=of broil2 def]      {\sized{broil}};
