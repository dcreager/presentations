...
\begin{frame}[fragile]
    \frametitle{Why is this hard?}
    \uncover<2-3>{\highlightdef{def}}
    \uncover<2-3>{\highlightboth{import}}
    \uncover<2-3>{\highlightref{ref}}
    \begin{center}
...
\begin{frame}[fragile]
    \uncover<2-3>{\highlightdef{def}}
    \uncover<2-3>{\highlightboth{kitchen_import}}
    \uncover<2-3>{\highlightboth{chef_import}}
    \uncover<2-3>{\highlightref{ref}}
    \frametitle{Why is this hard?}
    \begin{center}
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[baseline={([yshift=2em] current bounding box.center)}]
        ...
        \node (broil ref)  [highlight node on=<2>]
                           [reference]   [right=of s2]            {broil};
        \node (s3)         [anon scope]  [above=\scopegap of s2]  {};
        \node (import def) [pop]         [right=of s3]            {broil};
