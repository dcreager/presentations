...
\begin{frame}
    \begin{textblock*}{160mm}(0mm,0mm)
        % Ivan Radic
        % "Close-up of a compass graffiti on the ground"
        % CC-BY-2.0
        % https://flic.kr/p/2kGKMtM
...
\begin{frame}
    \begin{textblock*}{160mm}(0mm,0mm)
        % Marco Verch
        % "Close-up, a piece of yellow cake with red currant berries"
        % CC-BY-2.0
        % https://flic.kr/p/2jikJsQ
...
\begin{frame}[fragile]
    ...
    \begin{center}
    \begin{minipage}{10em}
    \begin{minted}[autogobble,frame=single,framesep=6pt,label={\tikzmark{file_start}stove.py\tikzmark{file_end}},escapeinside=??]{python}
...
\begin{frame}[fragile]
    ...
    \begin{center}
    \begin{minipage}[t]{15em}
    \begin{minted}[autogobble,frame=single,framesep=6pt,label={\tikzmark{file_start}kitchen.py\tikzmark{file_end}},escapeinside=??]{python}
...
\begin{frame}
    \begin{textblock*}{160mm}(0mm,0mm)
        % Marco Verch
        % "Stack of pancakes with berries on a plate"
        % CC-BY-2.0
        % https://flic.kr/p/2jYUh8M
...
\begin{frame}[fragile]
    ...
    \begin{center}
        ...
        \end{minipage}
        \vskip 2em
        \begin{minipage}[c][2cm][c]{0.45\textwidth}
            \begin{center}
            The reference at \textsl{kitchen.py:3:1} \\
            refers to \texttt{stove.broil} in some other file
            \end{center}
...
\begin{frame}[fragile]
    ...
    \begin{minipage}{9em}
    \begin{minted}[autogobble,frame=single,framesep=6pt,label=stove.py]{python}
        def bake():
            pass
...
\begin{frame}[fragile]
    ...
    \begin{minipage}{0.75\textwidth}
    \begin{minipage}{12em}
    \begin{minted}[autogobble,fontsize=\tiny,escapeinside=??]{text}
        (module [0, 0] - [10, 0]
    ...
    \begin{minipage}{15em}
    \begin{uncoverenv}<2- >
    \begin{minted}[autogobble,escapeinside=??,fontsize=\footnotesize]{text}
        (function_definition
