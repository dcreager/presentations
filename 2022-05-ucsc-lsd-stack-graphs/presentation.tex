...
\newcommand{\currentscopestack}[1]{\textsmaller[2]{\makesamewidth[l]{Symbol stack:}{Scope stack:}} \scopestack{#1}}
...
\begin{frame}[fragile]
    ...
    \begin{minipage}{0.5\textwidth}
    \begin{overprint}
        \onslide<5,39>                \currentsymbolstack{}
        \onslide<6,37-38>             \currentsymbolstack{one}
        \onslide<7,23-24,27,31,35-36> \currentsymbolstack{.one}
        \onslide<8,13,22>             \currentsymbolstack{$\scoped{()}{A}$.one}
        \onslide<9-12,14,19-21>       \currentsymbolstack{passthrough$\scoped{()}{A}$.one}
        \onslide<15,18>               \currentsymbolstack{.passthrough$\scoped{()}{A}$.one}
        \onslide<16-17>               \currentsymbolstack{dataflow.passthrough$\scoped{()}{A}$.one}
        \onslide<25-26>               \currentsymbolstack{x.one}
        \onslide<28-30>               \currentsymbolstack{0.one}
        \onslide<32-34>               \currentsymbolstack{A.one}
    \end{overprint}
    \begin{overprint}
        \onslide<5-22,30- >           \currentscopestack{}
        \onslide<23-29>               \currentscopestack{A}
    \end{overprint}
    \end{minipage}
    \end{center}
\end{frame}
