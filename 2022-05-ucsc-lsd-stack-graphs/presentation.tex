...
\begin{frame}[t,fragile]
    ...
    \uncover<3- >{\partialpath
        {\symbolstack{stove.Stove()} \cdot \psi}{\phi}
        {\node [root node]{}}
...
\begin{frame}[t,fragile]
    ...
    \uncover<2- >{\partialpath
        {\symbolstack{.broil} \cdot \psi}{\phi}
        {\node [exported scope] {IM}}
        {\node [definition]{\PopSymbol{broil}}}
        {\psi}{\phi}}
    \vskip 0.75em
...
\begin{frame}[fragile]
    ...
    \vskip 3em
    \uncover<3- >{\partialpath
        {\symbolstack{kitchen.} \cdot \psi}{\phi}
        {\node [root node] {}}
        {\node [root node]{}}
        {\symbolstack{stove.} \cdot \psi}{\phi}}
    \vskip 0.75em
    \uncover<4>{
...
\begin{frame}[fragile]
    ...
    \begin{center}
        ...
        \begin{center}
            \scalebox{0.75}{
                \onslide<3>{$\psi = \symbolstack{Stove().broil}, \phi = \nilscopestack$}
            }
        \end{center}
        \end{minipage}
        \vskip 0.5em
...
\begin{frame}[fragile]
    ...
    \begin{center}
        ...
        \begin{center}
            \scalebox{0.75}{
                \onslide<3>{$\psi = \symbolstack{.broil}, \phi = \nilscopestack$}
            }
        \end{center}
        \end{minipage}
        \vskip 0.5em
...
\begin{frame}[fragile]
    ...
    \begin{center}
        ...
        \begin{center}
            \scalebox{0.75}{
                \vphantom{$\psi = \symbolstack{Stove().broil}, \phi = \nilscopestack$}
            }
        \end{center}
        \end{minipage}
        \vskip 0.5em
