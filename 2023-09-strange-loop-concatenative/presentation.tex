        ...
        \begin{column}{70mm}
            ...
            \begin{equation*}
                \begin{array}{l@{\;}c@{\;}l}
                    ...
                    \hat{v} \cdot \quot{\textcolor{black}{$p_1$}}
                    \cdot \quot{\textcolor{black}{$p_2$}}
                    &\defeq&
                    \hat{v} \cdot \quot{\textcolor{black}{$p_1 ~ p_2$}} \\
                    \llbracket \sym{cons} \rrbracket\
                    \hat{v} \cdot \quot{\textcolor{black}{$p_1$}}
                    \cdot \quot{\textcolor{black}{$p_2$}}
                    &\defeq&
                    \hat{v} \cdot \quot{\quot{\textcolor{black}{$p_1$}}
                    \textcolor{black}{$p_2$}} \\
                    \llbracket \sym{dip} \rrbracket\
                    \hat{v} \cdot \quot{\textcolor{black}{$p_1$}}
                    \cdot \quot{\textcolor{black}{$p_2$}}
                    &\defeq&
                    \llbracket p_2 ~ \quot{\textcolor{black}{$p_1$}} \rrbracket\
                    \hat{v} \\
                    \llbracket \sym{quote} \rrbracket\
                    \hat{v} \cdot v
                    &\defeq&
                    \hat{v} \cdot \quot{\textcolor{black}{$v$}} \\
                \end{array}%
            \end{equation*}
            \end{uncoverenv}
        \end{column}
