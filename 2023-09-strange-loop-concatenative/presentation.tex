...
\newcommand{\picturecredit}[4]{
    \protected@xappto\picturecredits{
        ...
        \ifstrempty{#4}{\textsmaller[4]{#3}}{\textsmaller[4]{#3, \url{#4}}} \\[-0.5em]
    }
}
\makeatother
...
\begin{frame}[t,fragile]
    ...
    \begin{columns}[t]
        \begin{column}<+->{80mm}
            \begin{equation*}
                \begin{array}{l@{\;\,}c@{\,\;}l@{\quad}l}
                    ...
                    \only<.(2)-.(9)>{&\qeq& \hat{v} \cdot \val{3}}
                    \only<.(10)>{&\yeq& \hat{v} \cdot \val{3}}
                    \only<.(4)->{
                        \\ && \hphantom{%
        ...
        \begin{column}{50mm}
            ...
            \only<.(5)>{\highlightmath{sub1}}%
            \only<.(6)>{\highlightmath{subprog}}%
            \only<.(7)>{\highlightmath{sub2}}%
            \only<.(8)>{\highlightmath{subplus}}%
            \begin{equation*}
                \begin{array}{l@{\;\,}c@{\,\;}l@{\quad}l}
                    \tikzmark{sub1_start}
...
\begin{frame}
    ...
    \end{textblock*}
    \shadowedtitle{155mm - \titlewidth}{7mm}{Completeness}
\end{frame}
        ...
        \begin{equation*}
            \begin{array}{l@{\;}c@{\;}l}
                ...
                \alt<2>{&& \combwhy{\textsmaller[1]{concatenate}}}{
                    &=&
                    \ssym{[[apply] dip apply] cons cons}
                }
                \\
                \tikzmark{qcons_start}
                \ssym{cons}
...
\subsection{Apologies in advance}

\begin{frame}[t]
    \frametitle{Apologies in advance}
    \removedisplayskips
    ...
    \begin{equation*}
        \begin{array}{c@{\;\,}c@{\,\;}l}
            ...
            \only<+>{
                   \ssym{[[[[k] k] [] cake [] k cake k [] cake [] k cake [] k cake k [] cake cake k} \\[-0.5em]
                && \ssym{cake k [] cake [] k cake [] k cake k cake [] k [] cake [] k cake k [] cake} \\[-0.5em]
                && \ssym{[] k cake [] k cake k [[]] cake k k] [[k] [k] [] cake [] k cake k [] cake} \\[-0.5em]
                && \ssym{[] k cake [] k cake k [] cake cake k cake k [] cake [] k cake [] k cake k} \\[-0.5em]
                && \ssym{cake [] k [] cake [] k cake k [] cake [] k cake [] k cake k [[]] cake k k]]} \\[-0.5em]
                && \ssym{[[[[k] [k] [] cake [] k cake k [] cake [] k cake [] k cake k [] cake cake} \\[-0.5em]
                && \ssym{k cake k [] cake [] k cake [] k cake k cake [] k [] cake [] k cake k []} \\[-0.5em]
                && \ssym{cake [] k cake [] k cake k [[]] cake k k] [] cake [] k cake k [] cake [] k} \\[-0.5em]
                && \ssym{cake [] k cake k [] cake cake k cake k [] cake [] k cake [] k cake k cake} \\[-0.5em]
                && \ssym{[] k [] cake [] k cake k [] cake [] k cake [] k cake k [[]] cake k k] k]} \\[-0.5em]
                && \ssym{[] cake [] k cake k [] cake [] k cake [] k cake k [] cake cake k cake k []} \\[-0.5em]
                && \ssym{cake [] k cake [] k cake k cake [] k [] cake [] k cake k [] cake [] k cake} \\[-0.5em]
                && \ssym{[] k cake k [[]] cake k k}
            }
        \end{array}
    \end{equation*}
...
\begin{frame}
    \begin{center}
        \begin{tabular}{ccccccccc}
            \adjincludegraphics[width=15mm,valign=m]{languages/c.png}
            &\textlarger[3]{\textrm{\textbf{→}}}&
            \adjustbox{totalheight=12mm,valign=m}{\textbf{λ}}
            &\textlarger[3]{\textrm{\textbf{→}}}&
            \adjustbox{totalheight=11mm,valign=m}{\textbf{SK}}
            &\textlarger[3]{\textrm{\textbf{→}}}&
            \adjincludegraphics[width=15mm,valign=m]{pancakes-icon.png}
            &\textlarger[3]{\textrm{\textbf{→}}}&
            \adjincludegraphics[width=15mm,valign=m]{cake-slice-icon.png}
        \end{tabular}
    \end{center}
    \picturecredit{monkik}{Cake slice icon}{Flaticon Free License (with attribution)}{https://www.flaticon.com/free-icon/cake-slice_992754}
\end{frame}
...
\begin{frame}
    \begin{textblock*}{160mm}(-30mm,0mm)
        \picturecredit{Hundredrabbits}{uxn explode}{CC-BY-NC-SA-2.0}{https://100r.co/media/content/projects/uxnexplode.jpg}
        \adjincludegraphics[height=90mm]{uxnexplode.jpg}
    \end{textblock*}
    \flattitle{120mm - 0.5\titlewidth}{40mm}{uxn}
    \customtitle{120mm - 0.5\titlewidth}{46mm}{\url{https://100r.co/site/uxn.html}}
\end{frame}
