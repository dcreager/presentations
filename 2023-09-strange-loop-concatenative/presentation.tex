...
\begin{frame}[fragile]
    ...
    \begin{array}{c@{\quad}c@{\quad}l}
        \uncover<7->{i &\in& \mathbb{Z}} \\
        \uncover<7->{v &\defeq& i \defalt \quot{\prog}} \\
        \uncover<6->{\hat{v} &\defeq& \epsilon \defalt \hat{v} \cdot v} \\[2ex]
        ...
        \uncover<5->{
            \llbracket \prog \rrbracket &\defeq& \hat{v} \rightarrow \hat{v}
        } \\
    \end{array}
    \end{equation*}
    \vfill\vfill
