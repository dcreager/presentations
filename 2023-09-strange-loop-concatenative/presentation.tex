...
\begin{frame}
    ...
    \begin{equation*}
        \only<.(-1)-.>{\lambda x \ldot \lambda y \ldot y~x}
        \only<+>{\underline{\lambda x \ldot \lambda y \ldot y~x}}
        \only<+>{\underline{\lambda x \ldot \underline{\lambda y \ldot y~x}}}
        \only<+>{\underline{\lambda x \ldot (\Sc ~
        \underline{\lambda y \ldot y} ~
        \underline{\lambda y \ldot x})}}
        \only<+>{\underline{\lambda x \ldot (\Sc ~ \Ic ~
        \underline{\lambda y \ldot x})}}
        \only<+>{\underline{\lambda x \ldot (\Sc ~ \Ic ~
        (\Kc ~ \underline{x}))}}
        \only<+>{\underline{\lambda x \ldot (\Sc ~ \Ic ~
        (\Kc ~ x))}}
        \only<+>{(\Sc ~ \underline{\lambda x \ldot (\Sc ~ \Ic)} ~
