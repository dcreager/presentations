...
\begin{frame}
    ...
    \begin{onlyenv}<+>
        \adjustbox{totalheight=70mm}{\lstinputlisting[lastline=27]{rot13.lam}}
    \end{onlyenv}
\end{frame}
...
\begin{frame}[t]
    \frametitle{The stack language is\only<2-5>{ (almost)} Turing-complete}
    \removedisplayskips
        ...
        \begin{column}{70mm}
            ...
            \begin{equation*}
                \begin{array}{l@{\;}c@{\;}l}
                    ...
                    \cdot \mquot{p_2}
                    &\defeq&
                    \hat{v} \cdot \quot{\mquot{p_1}
                    \textcolor{black}{$p_2$}} \\
                    \llbracket \sym{dip} \rrbracket\
                    \hat{v} \cdot \mquot{p_1}
                    \cdot \mquot{p_2}
                    &\defeq&
                    \llbracket p_2 ~ \mquot{p_1} \rrbracket\
                    \hat{v} \\
...
\begin{frame}[t]
    ...
    \begin{equation*}
        \begin{array}{c@{\;\,}c@{\,\;}l}
            ...
            \only<+>{
                (\Sc ~ (\Kc ~ (\Sc ~ \underline{(\Sc ~ \Kc ~ \Kc)})) ~
                (\Sc ~ (\Kc ~ \Kc) ~ (\Sc ~ \Kc ~ \Kc)))
            }
            \only<+>{
                (\Sc ~ (\Kc ~ (\Sc ~ \underline{(\mquot{\Kc} ~ (\Sc ~ \Kc))})) ~
                (\Sc ~ (\Kc ~ \Kc) ~ (\Sc ~ \Kc ~ \Kc)))
            }
            \only<+>{
                (\Sc ~ (\Kc ~ (\Sc ~ (\mquot{\Kc} ~ \underline{(\Sc ~ \Kc)}))) ~
                (\Sc ~ (\Kc ~ \Kc) ~ (\Sc ~ \Kc ~ \Kc)))
            }
            \only<+>{
                (\Sc ~ (\Kc ~ (\Sc ~ (\mquot{\Kc} ~ \underline{\mquot{\Kc} ~ \Sc}))) ~
                (\Sc ~ (\Kc ~ \Kc) ~ (\Sc ~ \Kc ~ \Kc)))
            }
            \only<+>{
                (\Sc ~ (\Kc ~ \underline{(\Sc ~ (\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc))}) ~
                (\Sc ~ (\Kc ~ \Kc) ~ (\Sc ~ \Kc ~ \Kc)))
            }
            \only<+>{
                (\Sc ~ (\Kc ~ \underline{(\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc)}) ~
                (\Sc ~ (\Kc ~ \Kc) ~ (\Sc ~ \Kc ~ \Kc)))
            }
            \only<+>{
                (\Sc ~ \underline{(\Kc ~ (\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc))} ~
                (\Sc ~ (\Kc ~ \Kc) ~ (\Sc ~ \Kc ~ \Kc)))
            }
            \only<+>{
                (\Sc ~ \underline{(\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc)} ~
                (\Sc ~ (\Kc ~ \Kc) ~ (\Sc ~ \Kc ~ \Kc)))
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                (\Sc ~ \underline{(\Kc ~ \Kc)} ~ (\Sc ~ \Kc ~ \Kc)))
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                (\Sc ~ \underline{(\mquot{\Kc} ~ \Kc)} ~ (\Sc ~ \Kc ~ \Kc)))
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                (\Sc ~ (\mquot{\Kc} ~ \Kc) ~ \underline{(\Sc ~ \Kc ~ \Kc)}))
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                (\Sc ~ (\mquot{\Kc} ~ \Kc) ~ \underline{(\mquot{\Kc} ~ (\Sc ~ \Kc))}))
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                (\Sc ~ (\mquot{\Kc} ~ \Kc) ~ (\mquot{\Kc} ~ \underline{(\Sc ~ \Kc)})))
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                (\Sc ~ (\mquot{\Kc} ~ \Kc) ~ (\mquot{\Kc} ~ \underline{\mquot{\Kc} ~ \Sc})))
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                \underline{(\Sc ~ (\mquot{\Kc} ~ \Kc) ~ (\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc))})
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                \underline{(\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ (\Sc ~ (\mquot{\Kc} ~ \Kc)))})
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                (\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \underline{(\Sc ~ (\mquot{\Kc} ~ \Kc))}))
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                (\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \underline{(\mquot{\mquot{\Kc} ~ \Kc} ~ \Sc)}))
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                \underline{(\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ (\mquot{\mquot{\Kc} ~ \Kc} ~ \Sc))})
            }
            \only<+>{
                (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                \underline{(\mquot{\mquot{\mquot{\Kc} ~ \Kc} ~ \Sc} ~ \mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc})})
            }
            \only<+>{
                \underline{(\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc) ~
                (\mquot{\mquot{\mquot{\Kc} ~ \Kc} ~ \Sc} ~ \mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc}))}
            }
            \only<+>{
                \underline{\mquot{\mquot{\mquot{\mquot{\Kc} ~ \Kc} ~ \Sc} ~ \mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc}} ~
                    (\Sc ~ (\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc))
                }
            }
            \only<+>{
            ...
            \only<+>{
                \mquot{\mquot{\mquot{\mquot{\Kc} ~ \Kc} ~ \Sc} ~ \mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc}} ~
                    \underline{\mquot{\mquot{\mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc} ~ \Sc} ~ \Kc} ~ \Sc}
            }
            \only<+>{
                \mquot{\mquot{\mquot{\mquot{\Kc} ~ \Kc} ~ \Sc} ~ \mquot{\mquot{\Kc} ~ \mquot{\Kc} ~ \Sc}} ~
